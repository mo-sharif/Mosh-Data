...
export class DashboardComponent implements OnInit {
  ...
  public url:any;
  public image:any = '../assets/img/bg5.jpg';
  ...
  constructor() { }
   ...
   fetchData(url) {
    ...
    .then(json => {
      ...
      let publisher = json.data.publisher;
   ...
   ngOnInit() {
    fetch('https://api.microlink.io?url=https://www.mosh-media.com')
    .then(response => response.json())
    .then(json => {
      this.fetchedData = json.data;
      this.title = json.data.title;
      this.description = json.data.description;
      this.publisher = json.data.publisher;
      this.url = json.data.url;
      this.image = json.data.image.url;
